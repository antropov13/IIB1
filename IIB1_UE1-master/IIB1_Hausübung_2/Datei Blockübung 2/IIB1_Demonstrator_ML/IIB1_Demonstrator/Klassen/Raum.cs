...
namespace IIB1_Demonstrator.Klassen
{
    ...
    public class Raum
    {
        ...
        public string RaumNummer { get { return raumNummer; } set { raumNummer = value.Split(' ')[1]; } }
        public string RaumName {
            get { return this.GetType().Name + raumNummer; } }
        ...
        public Raum(Raum _raum)
        {
            ...
            this.raumNummer = _raum.RaumNummer;
        ...
        public Raum (double flaeche, String raumNummer, BindingList<Fenster> fensterListe, string _revitId)
        {
